...
namespace Angular.Migrations
{
    ...
    [Migration("20190708003045_MediaV0.2")]
    partial class MediaV02
    {
            ...
            modelBuilder.Entity("Angular.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 7, 8, 2, 30, 45, 187, DateTimeKind.Local).AddTicks(6004)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostMediaId = 1,
                            PostUserId = 1,
                            PostedAt = new DateTime(2019, 7, 6, 0, 30, 45, 187, DateTimeKind.Utc).AddTicks(5738),
                            Title = "Kaas"
                        },
                        new
                        {
                            ...
                            PostMediaId = 1,
                            PostUserId = 1,
                            PostedAt = new DateTime(2019, 7, 9, 0, 30, 45, 187, DateTimeKind.Utc).AddTicks(5740),
                            Title = "Kaas"
                        },
                        new
                        {
                            ...
                            PostMediaId = 1,
                            PostUserId = 1,
                            PostedAt = new DateTime(2019, 7, 8, 0, 30, 45, 187, DateTimeKind.Utc).AddTicks(5742),
                            Title = "Kaas"
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 7, 8, 0, 30, 45, 194, DateTimeKind.Utc).AddTicks(5245),
                            Rating = (short)5,
                            ReviewTargetId = 1,
                            ReviewUserId = 1
                        });
            ...
            modelBuilder.Entity("Angular.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2019, 7, 8, 2, 30, 45, 185, DateTimeKind.Local).AddTicks(8240),
                            City = "Stadskanaal",
                            Firstname = "Jans",
                            Gender = "M",
                            Lastname = "Jansen",
