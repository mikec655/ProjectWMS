...
namespace Angular.Migrations
{
    ...
    [Migration("20190628095259_FoodShareVersion0.1.7.1")]
    partial class FoodShareVersion0171
    {
            ...
            modelBuilder.Entity("Angular.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 6, 28, 11, 52, 59, 221, DateTimeKind.Local).AddTicks(122)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostMediaId = 0,
                            PostUserId = 1,
                            PostedAt = new DateTime(2019, 6, 28, 11, 52, 59, 220, DateTimeKind.Local).AddTicks(6876)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 6, 28, 9, 52, 59, 230, DateTimeKind.Utc).AddTicks(1550),
                            Rating = (short)5,
                            ReviewTargetId = 1,
                            ReviewUserId = 1
                        });
            ...
            modelBuilder.Entity("Angular.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2019, 6, 28, 11, 52, 59, 218, DateTimeKind.Local).AddTicks(7050),
                            City = "Stadskanaal",
                            Firstname = "Jans",
                            Gender = "M",
                            Lastname = "Jansen",
