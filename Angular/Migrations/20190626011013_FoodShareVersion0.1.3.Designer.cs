...
namespace Angular.Migrations
{
    ...
    [Migration("20190626011013_FoodShareVersion0.1.3")]
    partial class FoodShareVersion013
    {
            ...
            modelBuilder.Entity("Angular.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 6, 26, 3, 10, 13, 191, DateTimeKind.Local).AddTicks(8502)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Message = "Kaas",
                            PostUserId = 1,
                            PostedAt = new DateTime(2019, 6, 26, 3, 10, 13, 191, DateTimeKind.Local).AddTicks(4916)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2019, 6, 26, 3, 10, 13, 189, DateTimeKind.Local).AddTicks(1202),
                            City = "Stadskanaal",
                            Firstname = "Jans",
                            Gender = "M",
                            Lastname = "Jansen",
