...
namespace Angular.Migrations
{
    ...
    [Migration("20190627182307_FoodShareVersionV0.1.6")]
    partial class FoodShareVersionV016
    {
            ...
            modelBuilder.Entity("Angular.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 6, 27, 20, 23, 6, 687, DateTimeKind.Local).AddTicks(979)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Message = "Kaas",
                            PostUserId = 1,
                            PostedAt = new DateTime(2019, 6, 27, 20, 23, 6, 686, DateTimeKind.Local).AddTicks(5930)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 6, 27, 18, 23, 6, 696, DateTimeKind.Utc).AddTicks(366),
                            Rating = (short)5,
                            ReviewTargetId = 1,
                            ReviewUserId = 1
                        });
            ...
            modelBuilder.Entity("Angular.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2019, 6, 27, 20, 23, 6, 684, DateTimeKind.Local).AddTicks(1356),
                            City = "Stadskanaal",
                            Firstname = "Jans",
                            Gender = "M",
                            Lastname = "Jansen",
