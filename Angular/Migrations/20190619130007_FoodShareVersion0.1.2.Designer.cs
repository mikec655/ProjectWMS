...
namespace Angular.Migrations
{
    ...
    [Migration("20190619130007_FoodShareVersion0.1.2")]
    partial class FoodShareVersion012
    {
            ...
            modelBuilder.Entity("Angular.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedAt = new DateTime(2019, 6, 19, 15, 0, 7, 101, DateTimeKind.Local).AddTicks(7763)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Message = "Kaas",
                            PostUserId = 1,
                            PostedAt = new DateTime(2019, 6, 19, 15, 0, 7, 101, DateTimeKind.Local).AddTicks(4595)
                        });
                });
            ...
            modelBuilder.Entity("Angular.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2019, 6, 19, 15, 0, 7, 99, DateTimeKind.Local).AddTicks(7161),
                            Firstname = "Jans",
                            Gender = "M",
                            Lastname = "Jansen",
                            More = 0,
